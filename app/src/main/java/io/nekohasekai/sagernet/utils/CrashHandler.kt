...
object CrashHandler : Thread.UncaughtExceptionHandler {
    ...
    override fun uncaughtException(thread: Thread, throwable: Throwable) {
        ...
        Log.e("YiLink", "uncaughtException", throwable)

        val logFile = File.createTempFile("YiLink Crash Report ",
            ".log",
    ...
    fun buildReportHeader(): String {
        var report = ""
        report += "YiLink ${BuildConfig.VERSION_NAME} (${BuildConfig.VERSION_CODE}) ${BuildConfig.FLAVOR.uppercase()}\n"
